...
const AddEvent = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-orange-600 via-orange-300 to-orange-200 px-4">
            ...
            <div className="bg-white dark:bg-gray-900 shadow-2xl rounded-2xl w-full max-w-5xl flex flex-col md:flex-row overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-8">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="text-center mb-6">
                            <h1 className="text-3xl font-extrabold text-orange-500 dark:text-purple-400">Add Event</h1>
                            <p className="text-gray-600 dark:text-gray-400 my-6">Fill the details below to create your event</p>
                        </div>
